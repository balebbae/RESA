...
function Calendar({
  ...
  // Calculate the week range if currentWeek is provided
  // Use a matcher function instead of Date array for reliable date comparison
  const currentWeekMatcher = React.useMemo(() => {
  ...
  return (
    <DayPicker
      ...
      modifiers={{
        currentWeek: currentWeekMatcher,
        ...props.modifiers,
      }}
      modifiersClassNames={{
        currentWeek: "current-week-day",
      }}
      formatters={{
      ...
      classNames={{
        ...
        week: cn(
          "flex w-full mt-2 has-[.current-week-day]:bg-[#ebeae7] has-[.current-week-day]:rounded-md",
        ...
        day: cn(
          "relative w-full h-full p-0 flex justify-center items-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md group/day aspect-square select-none",
