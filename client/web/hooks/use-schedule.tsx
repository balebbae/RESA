    ...
    const timeout = setTimeout(() => {
      ...
      setOptimisticShifts((prev) =>
        prev.filter((shift) => {
          ...
          // Note: optimistic shifts use string IDs (e.g., "temp-...") even though type is number
          const shiftId = shift.id as unknown as string | number;
          if (typeof shiftId === 'string' && shiftId.startsWith('temp-')) {
            const timestamp = parseInt(shiftId.split('-')[1]);
